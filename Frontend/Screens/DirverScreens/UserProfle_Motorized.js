...
const HelpCenterButton = () => {
    ...
    const handleHelpPress = () => {
      ...
      },3); // Cambia el color por 200ms y luego vuelve al color original
    };
...
const Settings = () => {
  ...
  const handleLogoutPress = () => {
    ...
    }, 5); // Cambia el color por 200ms y luego vuelve al color original
  };
  ...
  return (
    <ScrollView contentContainerStyle={styles.settingsContainer}>
      ...
      <View style={styles.settingItem}>
        ...
        <Text style={styles.settingAction}>Motorizado</Text>
      </View>
      <View style={styles.settingItem}>
        ...
        <Icon name="chevron-right" style={styles.settingActionIcon} />
      </View>
...
export default UserProfile_Motorized;
